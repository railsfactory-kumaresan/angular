include ActiveAdmin
ActiveAdmin.register EmailActivity , namespace: :email_clicks do
  ...
  index :title => 'Email Clicked customer details' do
    column("Question",:question) unless params[:slug].present?
    column("Clicked At", :date)
    column("Name", :name)
    column("Email",:email)
  ...
  controller do
    ...
    def scoped_collection
      Question.fetch_activity_results(params,"clicks")
    end
