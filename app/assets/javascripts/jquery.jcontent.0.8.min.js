(function (a) {
    a.fn.jContent = function (b) {
        var f = "div.slides", e = "next", c = false, d = "horizontal", g = this, b = a.extend({speed: 500, orientation: d, auto: c, direction: e, pause: 5e3, circle: c, easing: "", xml: "", pause_on_hover: c, width: 230, height: 1000, videos: c}, b);
        this.init = function (g) {
            var h = "prev", m = "vertical", l = "div.panel", k = "left", j = "height", i = "width", n = "position";
            g.div = a(g);
            ...
            if (b.orientation == d)g.div.addClass("jc-horizontal"); else g.div.addClass("jc-vertical");
            ...
            g.clone_slide = function (b) {
                var a = g.slides.eq(b).show(), c = "<div style='" + a.attr("style") + "'>" + a.html() + "</div>";
                a.hide();
                return c
            };
            ...
            g.getAnimateArgs = function (c) {
                ...
                switch (b.orientation) {
                    case d:
                        if (c == h)a = {left: 0}; else a = {left: -2 * b.width};
                        break;
                    case m:
                        if (c == h)a = {top: 0}; else a = {top: -2 * b.height}
                }
                return a
            };
            g.performAimate = function (a) {
                g.panel.animate(g.getAnimateArgs(a), b.speed, b.easing, function () {
                    if (a == h)g.currentSlide = g.getPrevIndex(); else g.currentSlide = g.getNextIndex();
            ...
            g.animation = function (a) {
                ...
                if (b.auto)setTimeout(function () {
                    ...
                    }, 250); else g.performAimate(a)
                }, b.pause); else g.performAimate(a)
            };
            g.go = function (a) {
                if (a == h)(!g.isFirstItem() || b.auto || b.circle) && g.animation(h); else(!g.isLastItem() || b.auto || b.circle) && g.animation(e)
            };
        ...
        return this.each(function () {
            var d = this;
            if (b.xml != "")a.ajax({url: b.xml, type: "GET", cache: c, success: function (c) {
                var b = a("slide", c);
