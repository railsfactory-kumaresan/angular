class Users::ConfirmationsController < Devise::ConfirmationsController
  ...
  def show
    ...
    if resource.errors.empty?
      ...
      #ClientSetting.create_client_setting(resource)
      #create sub account for make a call
      ShareQuestion.create_sub_account(resource)
      BusinessCustomerInfo.sub_account_create(resource) # create subaccount for mandrill-api
