                ...
                <table border='0' cellpadding='0' cellspacing='0' width='90%'>
                  <tr>
                    <td valign='top' class='lowerHeaderContent'>
                      <div mc:edit='upper_header_content' class='HeaderWrapper'>
                          <div class='Headerlogo'>*|HTML:IMAGE|*</div>
                          <div class='HeaderCompanyName'>*|UPPER:COMPANYNAME|*</div>
                      </div>
                    </td>
                  </tr>
                </table>
          ...
          <table border='0' cellpadding='0' cellspacing='0' width='100%' id='templateFooter'>
            <tr>
              <td align='center' valign='top'>
                ...
                <table border='0' cellpadding='0' cellspacing='0' width='90%' class='footerContent'>
                  <tr>
                    <td valign='top'>
                      <div mc:edit='std_footer'>
                          <div style='float: right;'>
                              <p>Powered by</p>
                                <a href='http://www.inquirly.com'><img src='https://signin.inquirly.com/logo-bottom.png' id='headerImage campaign-icon' mc:label='header_image' mc:edit='header_image' mc:allowdesigner='' mc:allowtext='' alt='Inquirly'></a></div>
                          <div style='float: left;'><p style='margin-top: 30px;'>Copyright &copy; 2014, All rights reserved.</p></div>
