	...
	<div class="post">
		...
		<div class="entry" id="archives">
			...
			while ( have_posts() ) :
				...
				?><li><span class="date"><?php the_time( 'M j' ); ?><sup><?php the_time( 'S') ?></sup></span> <span class="linked"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></span> <span class="comments"><?php comments_popup_link(__( '0', 'wpzoom' ), __( '1', 'wpzoom' ), __( '%', 'wpzoom' )); ?></span></li><?php
